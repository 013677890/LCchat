...
| 2.3 | 搜索用户 | 通过邮箱/昵称/ID 搜索用户 | P0 | `user_info` |
| 2.4 | 更新基本信息 | 修改昵称、性别、生日、签名 | P0 | `user_info` |
| 2.5 | 更新头像 | 修改用户头像 | P0 | `user_info` |
| 2.6 | 修改密码 | 旧密码 + 新密码修改 | P1 | `user_info` |
| 2.7 | 绑定/换绑邮箱 | 更换绑定邮箱（需验证码） | P1 | `user_info` |
| 2.8 | 绑定/换绑手机 | 更换绑定手机号（预留扩展） | P2 | `user_info` |
| 2.9 | 获取用户二维码 | 生成个人二维码（用于加好友） | P1 | `user_info` |
| 2.10 | 解析二维码 | 通过二维码内容获取用户信息 | P1 | `user_info` |
| 2.11 | 注销账号 | 删除账号（软删除 + 数据保留期） | P2 | `user_info` |
| 2.12 | 批量获取用户信息 | 内部服务调用，批量查询用户 | P0 | `user_info` |
...
| 序号 | 功能 | 说明 | 优先级 | 数据依赖 |
|:----:|------|------|:------:|----------|
| 3.1 | 发送好友申请 | 向目标用户发送好友请求 | P0 | `apply_request` |
| 3.2 | 获取好友申请列表 | 获取收到的好友申请 | P0 | `apply_request` |
| 3.3 | 获取发出的申请列表 | 获取自己发出的申请（可选） | P2 | `apply_request` |
| 3.4 | 处理好友申请 | 同意/拒绝好友请求 | P0 | `apply_request`, `user_relation` |
| 3.5 | 获取未读申请数量 | 红点提示用 | P1 | `apply_request` |
| 3.6 | 标记申请已读 | 清除红点 | P1 | `apply_request` |
| 3.7 | 获取好友列表 | 获取所有好友及信息 | P0 | `user_relation` |
| 3.8 | 删除好友 | 单向删除好友关系 | P0 | `user_relation` |
| 3.9 | 设置好友备注 | 给好友设置备注名 | P1 | `user_relation` |
| 3.10 | 设置好友标签 | 给好友分组/打标签 | P2 | `user_relation` |
| 3.11 | 获取标签列表 | 获取所有好友标签 | P2 | `user_relation` |
| 3.12 | 判断是否好友 | 内部接口，判断两用户关系 | P1 | `user_relation` |
| 3.13 | 获取关系状态 | 内部接口，获取详细关系（好友/拉黑/无） | P1 | `user_relation` |
...
| `profile/` | 用户信息相关：个人信息增删改查、搜索用户、二维码、账号设置 | 模块二 |
| `friend/` | 好友关系相关：申请、列表、备注、标签 | 模块三 |
