...
func (h *GroupHandler) LeaveGroup(ctx context.Context, req *pb.LeaveGroupRequest) (*pb.LeaveGroupResponse, error) {
	return &pb.LeaveGroupResponse{}, h.groupService.LeaveGroup(ctx, req)
}
...
func (h *GroupHandler) SearchGroupMembers(ctx context.Context, req *pb.SearchGroupMembersRequest) (*pb.SearchGroupMembersResponse, error) {
	return h.groupService.SearchGroupMembers(ctx, req)
}

// UpdateMyGroupNickname 更新当前用户自己的群名片。
func (h *GroupHandler) UpdateMyGroupNickname(ctx context.Context, req *pb.UpdateMyGroupNicknameRequest) (*pb.UpdateMyGroupNicknameResponse, error) {
	return &pb.UpdateMyGroupNicknameResponse{}, h.groupService.UpdateMyGroupNickname(ctx, req)
}

// UpdateGroupMemberNickname 更新指定成员群名片。
func (h *GroupHandler) UpdateGroupMemberNickname(ctx context.Context, req *pb.UpdateGroupMemberNicknameRequest) (*pb.UpdateGroupMemberNicknameResponse, error) {
	return &pb.UpdateGroupMemberNicknameResponse{}, h.groupService.UpdateGroupMemberNickname(ctx, req)
}

// MuteGroupMember 设置或取消指定成员单人禁言。
func (h *GroupHandler) MuteGroupMember(ctx context.Context, req *pb.MuteGroupMemberRequest) (*pb.MuteGroupMemberResponse, error) {
	return &pb.MuteGroupMemberResponse{}, h.groupService.MuteGroupMember(ctx, req)
}

// UpdateGroupMuteSetting 更新全员禁言开关。
func (h *GroupHandler) UpdateGroupMuteSetting(ctx context.Context, req *pb.UpdateGroupMuteSettingRequest) (*pb.UpdateGroupMuteSettingResponse, error) {
	return &pb.UpdateGroupMuteSettingResponse{}, h.groupService.UpdateGroupMuteSetting(ctx, req)
}
...
func (h *GroupHandler) SearchGroups(ctx context.Context, req *pb.SearchGroupsRequest) (*pb.SearchGroupsResponse, error) {
	return h.groupService.SearchGroups(ctx, req)
}
...
func (h *GroupHandler) CheckGroupSendPermission(ctx context.Context, req *pb.CheckGroupSendPermissionRequest) (*pb.CheckGroupSendPermissionResponse, error) {
	return h.groupService.CheckGroupSendPermission(ctx, req)
}

// GetJoinRequestPendingCount 获取群待审批入群申请数量。
func (h *GroupHandler) GetJoinRequestPendingCount(ctx context.Context, req *pb.GetJoinRequestPendingCountRequest) (*pb.GetJoinRequestPendingCountResponse, error) {
	return h.groupService.GetJoinRequestPendingCount(ctx, req)
}
