...
type IGroupService interface {
	...
	LeaveGroup(ctx context.Context, req *pb.LeaveGroupRequest) error
	// RemoveMember 移除群成员。
	...
	SearchGroupMembers(ctx context.Context, req *pb.SearchGroupMembersRequest) (*pb.SearchGroupMembersResponse, error)
	// UpdateMyGroupNickname 更新当前用户自己的群名片。
	UpdateMyGroupNickname(ctx context.Context, req *pb.UpdateMyGroupNicknameRequest) error
	// UpdateGroupMemberNickname 管理员或群主修改指定成员群名片。
	UpdateGroupMemberNickname(ctx context.Context, req *pb.UpdateGroupMemberNicknameRequest) error
	// MuteGroupMember 设置或取消指定成员单人禁言。
	MuteGroupMember(ctx context.Context, req *pb.MuteGroupMemberRequest) error
	// UpdateGroupMuteSetting 更新全员禁言开关。
	UpdateGroupMuteSetting(ctx context.Context, req *pb.UpdateGroupMuteSettingRequest) error
	...
	SearchGroups(ctx context.Context, req *pb.SearchGroupsRequest) (*pb.SearchGroupsResponse, error)
	...
	CheckGroupSendPermission(ctx context.Context, req *pb.CheckGroupSendPermissionRequest) (*pb.CheckGroupSendPermissionResponse, error)
	// GetJoinRequestPendingCount 获取群待审批入群申请数量。
	GetJoinRequestPendingCount(ctx context.Context, req *pb.GetJoinRequestPendingCountRequest) (*pb.GetJoinRequestPendingCountResponse, error)
}
