...
type UserRelation struct {
	...
	UserUuid      string         `gorm:"column:user_uuid;type:char(20);not null;index;uniqueIndex:uidx_user_peer;comment:用户uuid"`
	PeerUuid      string         `gorm:"column:peer_uuid;type:char(20);not null;index;uniqueIndex:uidx_user_peer;comment:对端用户uuid"`
	Status        int8           `gorm:"column:status;not null;default:0;comment:关系状态 0待确认 1已添加 2已拉黑 3已拒绝"`
